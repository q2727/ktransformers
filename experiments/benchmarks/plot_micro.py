...
def plot(summary_path: Path, output_path: Path) -> None:
    ...
    if benchmark == "prefill":
        ...
        p95_values = [1000 * float(point["tpot_p95_seconds"]) for point in points]
    ...
    y_max = nice_upper(max(p95_values) * 1.08)
    ...
    colors = (("Median", median_values, "#146c94"), ("P95", p95_values, "#d1495b"))
