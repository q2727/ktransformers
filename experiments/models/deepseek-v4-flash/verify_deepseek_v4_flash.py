...
model = Path(os.environ.get("MODEL", "/data/qinchong/models/DeepSeek-V4-Flash"))
...
checks = {
    ...
    "architecture": "DeepseekV4ForCausalLM" in config.get("architectures", []),
    "native_fp4_experts": config.get("expert_dtype") == "fp4",
    ...
    json.dumps(
        {
            ...
            "experts_per_layer": config.get("n_routed_experts"),
